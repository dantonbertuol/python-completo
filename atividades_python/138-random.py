...
lista = ['Danton', 'José', 'Maria', 'Rose', 'Jenny', 'Danilo', 'Felipe']

# Seleciona aleatóriamente valores de uma lista
sorteio = random.sample(lista, 2) # Não retorna o mesmo valor nos dois itens
# sorteio = random.choices(lista, k=2) # Pode retornar o mesmo valor nos dois itens ['Danton', 'Danton']
