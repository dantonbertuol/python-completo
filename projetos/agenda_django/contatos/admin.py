...
class ContatoAdmin(admin.ModelAdmin):
    list_display = ('id', 'nome', 'sobrenome', 'telefone', 'email', 'data_criacao', 'categoria', 'mostrar') # Colunas que serão exibidas
    ...
    list_editable = ('telefone', 'mostrar') # Campos que podem ser editados em tela sem acessar o contato
