...
booleano: bool = False
string: str = 'Danton Jose'

# Sequências
lista: List[int] = [1, 2, 3]
lista_str_int: List[Union[int, str]] = [1, 2, 3, 'Danton']
tupla: Tuple[int, int, int, str] = (1, 2, 3, 'Danton')
...
pessoa: Dict[str, Union[str, int]] = {
    'nome': 'Danton Jose', 'sobrenome': 'Bertuol', 'idade': 25}
pessoa2: MeuDict = {'nome': 'Danton Jose',
                    'sobrenome': 'Bertuol', 'idade': 25, 'l': [1, 2]}
